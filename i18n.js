...
(function () {
  const RICH = [
    ...
    ['<a href="https://www.qirapagos.com" target="_blank" rel="noopener noreferrer" class="underline hover:text-white transition-colors" style="color: var(--ink);">Qira Pagos</a> is a mobile-first digital wallet designed for Argentina\'s agricultural ecosystem, connecting <span style="color: var(--ink);">producers, distributors, grain operators, aggregators, exporters and businesses</span> around a single, simple product.',
     '<a href="https://www.qirapagos.com" target="_blank" rel="noopener noreferrer" class="underline hover:text-white transition-colors" style="color: var(--ink);">Qira Pagos</a> es una billetera digital mobile-first diseñada para el ecosistema agropecuario argentino, conectando <span style="color: var(--ink);">productores, distribuidores, operadores de granos, acopiadores, exportadores y comercios</span> alrededor de un producto único y simple.'],
    ...
    ['I led the UX/UI design for Qira Pagos as part of the <a href="/radium-rocket" class="underline hover:text-white transition-colors" style="color: var(--ink);">Radium Rocket</a> team, for the agribusiness company <a href="https://www.alz-agro.com.ar" target="_blank" rel="noopener noreferrer" class="underline hover:text-white transition-colors" style="color: var(--ink);">ALZ Agro</a>. I worked closely with product and engineering to translate a complex financial domain into a mobile experience that felt straightforward and trustworthy.',
     'Lideré el diseño UX/UI de Qira Pagos como parte del equipo de <a href="/radium-rocket" class="underline hover:text-white transition-colors" style="color: var(--ink);">Radium Rocket</a>, para la empresa del agro <a href="https://www.alz-agro.com.ar" target="_blank" rel="noopener noreferrer" class="underline hover:text-white transition-colors" style="color: var(--ink);">ALZ Agro</a>. Trabajé codo a codo con producto e ingeniería para traducir un dominio financiero complejo en una experiencia mobile simple y confiable.'],
    ['Among the clients I designed for was <a href="https://www.alz-agro.com.ar" target="_blank" rel="noopener noreferrer" class="underline hover:text-white transition-colors" style="color: var(--ink);">ALZ Agro</a>, the agribusiness company behind <a href="/qira-pagos" class="underline hover:text-white transition-colors" style="color: var(--ink);">Qira Pagos</a>, which I designed, and <a href="https://www.qiraglobal.com" target="_blank" rel="noopener noreferrer" class="underline hover:text-white transition-colors" style="color: var(--ink);">Qira Global</a>, an e-commerce platform whose design and maintenance I led. For <a href="https://www.syngenta.com" target="_blank" rel="noopener noreferrer" class="underline hover:text-white transition-colors" style="color: var(--ink);">Syngenta</a>, I produced 3D video editing for VR experiences. My work also spanned other industries, including health, e-commerce, ERP and education.',
     'Entre los clientes para los que diseñé estuvo <a href="https://www.alz-agro.com.ar" target="_blank" rel="noopener noreferrer" class="underline hover:text-white transition-colors" style="color: var(--ink);">ALZ Agro</a>, la empresa del agro detrás de <a href="/qira-pagos" class="underline hover:text-white transition-colors" style="color: var(--ink);">Qira Pagos</a>, que diseñé, y <a href="https://www.qiraglobal.com" target="_blank" rel="noopener noreferrer" class="underline hover:text-white transition-colors" style="color: var(--ink);">Qira Global</a>, un e-commerce cuyo diseño y mantenimiento estuvieron a mi cargo. Para <a href="https://www.syngenta.com" target="_blank" rel="noopener noreferrer" class="underline hover:text-white transition-colors" style="color: var(--ink);">Syngenta</a> produje edición de video 3D para experiencias de VR. Mi trabajo también abarcó otros rubros, como salud, e-commerce, ERP y educación.'],
    ['<a href="https://radiumrocket.com/es/" target="_blank" rel="noopener noreferrer" class="underline hover:text-white transition-colors" style="color: var(--ink);">Radium Rocket</a> is a software professional services company that builds engineering teams developing leading mobile and web products. It operates as a true extension of its clients\' teams: identifying challenges, designing the product and building innovative software with agile engineering.',
     '<a href="https://radiumrocket.com/es/" target="_blank" rel="noopener noreferrer" class="underline hover:text-white transition-colors" style="color: var(--ink);">Radium Rocket</a> es una empresa de servicios profesionales de software que arma equipos de ingeniería para desarrollar productos mobile y web de primer nivel. Opera como una verdadera extensión de los equipos de sus clientes: identificando desafíos, diseñando el producto y construyendo software innovador con ingeniería ágil.'],
  ];
  ...
  const TEXT = [
    ...
    ["A curated selection of interfaces and products I've designed and shipped between 2022 and 2026.",
     'Una selección curada de interfaces y productos que diseñé y lancé entre 2022 y 2026.'],
